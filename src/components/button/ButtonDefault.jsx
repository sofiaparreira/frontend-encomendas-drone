...
const ButtonDefault = ({ text, onClick, type = "button", variant = "primary", disabled = false }) => {
    const baseClasses = "px-4 h-[50px] rounded-md font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed w-full cursor-pointer";
